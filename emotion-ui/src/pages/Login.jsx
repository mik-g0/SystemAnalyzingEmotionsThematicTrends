...
export default function Login() {
  ...
  return (
    <div className="auth-page-wrapper">
      ...
      <style>{`
        /* 1. Полный экран и глубокий черный цвет — один в один как в Register */
        .auth-page-wrapper {
        ...
        /* 2. ГИГАНТСКАЯ КАРТОЧКА (Максимальная ширина 640px) */
        .custom-auth-card {
          width: 100% !important;
        ...
        /* 4. Огромные заголовки на русском */
        .auth-title {
      ...
      <div className="custom-auth-card">
        ...
        <p className="auth-subtitle">Выполните вход для работы с системой автоматизированного анализа текстовых данных</p>
        {error && (
        ...
        <div className="custom-auth-btn-container">
          <Button onClick={handleLogin} disabled={loading}>
            {loading ? "Выполнение входа..." : "Войти в систему"}
          </Button>
        </div>
